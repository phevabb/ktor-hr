...
import com.hr.admin.repositories.LeaveTypeStatsRepository
import com.hr.auth.repositories.AuthRepository
import kotlin.math.ceil
import kotlin.math.max
import kotlin.math.min

object LeaveTypeStatsService {
    ...
    suspend fun getLeaveTypeStats(
        ...
        if (!isAdmin) {
            println(
                "Leave-type statistics access denied: " +
        ...
        return try {
            ...
            println(
                "Leave-type statistics returned: " +
                        "accountId=${account.id}, " +
                        "page=$safePage, " +
            ...
            LeaveTypeStatsResult.Success(
                statistics =
                    response
            )
        } catch (exception: Exception) {
            println(
                "Leave-type statistics failed: " +
                        "accountId=${account.id}, " +
