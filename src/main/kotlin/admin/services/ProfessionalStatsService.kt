...
import com.hr.admin.repositories.ProfessionalStatsRepository
import com.hr.auth.repositories.AuthRepository
import kotlin.math.ceil
import kotlin.math.max
import kotlin.math.min

object ProfessionalStatsService {
    ...
    suspend fun getProfessionalStats(
        ...
        val account =
            AuthRepository
                ...
                ?: return ProfessionalStatsResult
                    .AccountNotFound
        ...
        if (!isAdmin) {
            println(
                "Professional statistics access denied: " +
        ...
        return try {
            ...
            println(
                "Professional statistics returned: " +
                        "accountId=${account.id}, " +
                        "page=$safePage, " +
            ...
            ProfessionalStatsResult.Success(
                statistics =
                    response
            )
        } catch (exception: Exception) {
            println(
                "Professional statistics failed: " +
                        "accountId=${account.id}, " +
