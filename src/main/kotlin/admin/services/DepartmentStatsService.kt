...
import com.hr.admin.repositories.DepartmentStatsRepository
import com.hr.auth.repositories.AuthRepository
import kotlin.math.ceil
import kotlin.math.max
import kotlin.math.min

object DepartmentStatsService {

    suspend fun getDepartmentStats(
        accountId: Int,
        page: Int,
        pageSize: Int,
        requestPath: String
        ...
        if (!isAdmin) {
            println(
                "Department statistics access denied: " +
        ...
        return try {
            ...
            println(
                "Department statistics returned: " +
                        "accountId=${account.id}, " +
                        "page=$safePage, " +
            ...
            DepartmentStatsResult.Success(
                statistics =
                    response
            )
        } catch (exception: Exception) {
            println(
                "Department statistics failed: " +
                        "accountId=${account.id}, " +
